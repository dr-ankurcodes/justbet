...
auto_bet.py is for manual infinite cycle for dice roll on just.bet (modify config via variables on Top).
Currently Only 6 games (dice, limbo, hilo, coinflip, plinko, roll) playable out of 15 games publised by justbet account on just.bet

TO BE REPLACED BEFORE PROCEEDING:
1. JUSTBET_DIRECTORY_PATH - absolute path of this directory - in AGENTS.md, PROMPT.md, auto_bet.py
